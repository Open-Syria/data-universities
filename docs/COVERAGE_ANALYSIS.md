...
Use `pnpm run report:data` for first-pass coverage counts.

## Current Coverage

- 84 university and higher-institute records.
- 39 private, 12 public, 9 technical/high-institute, 1 virtual institution, and 23 other institutions.
- 40 records include Wikidata identifiers.
- 30 records currently have no official website.
